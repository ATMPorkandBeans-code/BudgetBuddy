...
class UserSchema(Schema):
    ...
    income = fields.Decimal(required=True, places=2, as_string=True)

    categories = fields.List(fields.Nested(lambda: CategorySchema(exclude=("user",))))
...
class CategorySchema(Schema):
    ...
    user = fields.Nested(UserSchema(exclude=("categories",)))
